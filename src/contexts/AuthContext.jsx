...
export function AuthProvider({ children }) {
  ...
  const value = useMemo(
    () => ({
      ...
      isKitchenLeader: isKitchenLeaderRole(profile),
      isRoomLeader: isRoomLeaderRole(profile),
      ...
      canSeeMealReviews: canSeeMealReviews(profile),
      canSeeMenuAnalytics: canSeeMenuAnalytics(profile),
      canSeeMaharajMenuDetails: canSeeMaharajMenuDetails(profile),
      canPlanMenus: canPlanMenus(profile),
      canEditMenuCatalog: canEditMenuCatalog(profile),
      canManageUsers: canManageUsers(profile),
      canManageSeva: canManageSeva(profile),
      canCreateLeaves: canCreateLeaves(profile),
